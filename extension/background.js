/**
 * Focus Gate — background.js
 * Service worker that builds and maintains the declarativeNetRequest
 * blocking rules from the stored site list, manual toggle, and schedule.
 * Also tracks resist stats (streaks, totals) whenever a block occurs.
 *
